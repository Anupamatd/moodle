...
class mariadb_native_moodle_database extends mysqli_native_moodle_database {
    ...
    protected function fetch_columns(string $table): array {
        ...
        foreach ($columns as $name => $column) {
            ...
            $info = new stdClass();
            $properties = [
                'name', 'type', 'max_length', 'scale', 'not_null', 'primary_key', 'auto_increment',
                'binary', 'has_default', 'default_value', 'unique', 'meta_type',
            ];
    ...
    protected function has_json_constraint(string $createsql, string $name): bool {
        // phpcs:ignore moodle.Strings.ForbiddenStrings.Found -- Match MariaDB's backtick-quoted identifiers.
